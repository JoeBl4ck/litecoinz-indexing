    ...
    platformStyle(platformStyle)
{
    ...
    QIcon icon = platformStyle->MultiColorIcon(":/images/warning");
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance, const CAmount& t_balance, const CAmount& z_balance, const CAmount& unshielded)
{
    ...
    current_tbalance = t_balance;
    current_zbalance = z_balance;
    current_unshielded = unshielded;
    ...
    ui->labelTBalance->setText(BitcoinUnits::formatWithUnit(unit, t_balance, false, BitcoinUnits::separatorAlways));
    ...
    if(walletModel && walletModel->getOptionsModel())
    {
        if(currentBalance != -1)
        {
            setBalance(currentBalance, currentUnconfirmedBalance, currentImmatureBalance,
                       ...
                       current_tbalance, current_zbalance, current_unshielded);
        }
