...
TEST(txid_tests, check_txid_and_hash_are_same) {
    // Random litecoinz transaction aacaa62d40fcdd9192ed35ea9df31660ccf7f6c60566530faaa444fb5d0d410e
    CTransaction tx;
...
TEST(txid_tests, check_txid_and_hash_are_same_coinbase) {
    // Random litecoinz coinbase transaction 6041357de59ba64959d1b60f93de24dfe5ea1e26ed9e8a73d35b225a1845bad5
    CTransaction tx;
