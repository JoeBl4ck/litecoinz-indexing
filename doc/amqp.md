...
router", implementing the LitecoinZ P2P protocol and relay, making
...
The AMQP feature in LitecoinZ requires [Qpid Proton](https://qpid.apache.org/proton/)
...
TLS support may be added once OpenSSL has been removed from the LitecoinZ
